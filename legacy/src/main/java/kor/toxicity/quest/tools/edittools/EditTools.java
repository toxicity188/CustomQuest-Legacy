...
public abstract class EditTools extends Tools {
	...
	protected void itemEdit(String t, boolean b, int i) {
		itemEdit(t,b,i,false);
	}
	protected void itemEdit(String t, boolean b, int i, boolean reverse) {
		unregisterEvents();
		ItemEditModule edit = (reverse) ? new ItemReverseEditModule() : new ItemEditModule();
