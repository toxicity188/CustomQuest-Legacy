...
public class DialogEdit extends EditTools {
	...
	private void reload(int line) {
		...
		inv.setItem(45, InvUtil.createItem(Material.BLUE_WOOL, prefix + "§fLinkedDialog:", getStringList("LinkedDialog")));
		inv.setItem(46, InvUtil.createItem(Material.BLUE_WOOL, prefix + "§fLinkedSubDialog:", getStringList("LinkedSubDialog")));
		inv.setItem(47, InvUtil.createItem(Material.YELLOW_WOOL, prefix + "§fVars(Condition):", getStringList("ConditionVars")));
		inv.setItem(48, InvUtil.createItem(Material.YELLOW_WOOL, prefix + "§fVars(Set):", getStringList("SetVars")));
		inv.setItem(49, InvUtil.createItem(Material.GREEN_WOOL, prefix + "§fQuest(Check):", getStringList("CheckQuest")));
		inv.setItem(50, InvUtil.createItem(Material.GREEN_WOOL, prefix + "§fQuest(Set):", getStringList("SetQuest")));
		inv.setItem(51, InvUtil.createItem(Material.PURPLE_WOOL, prefix + "§fLinkedQnA", getStringList("LinkedQnA")));
		inv.setItem(52, InvUtil.createItem(Material.PURPLE_WOOL, prefix + "§fLinkedPresent", getStringList("LinkedPresent")));
		inv.setItem(53, InvUtil.createItem(Material.RED_WOOL, prefix + "§fLinkedCommand", getStringList("LinkedCommand")));
	}
	private void TalkGui(int t) {
		...
		inv.setItem(26, InvUtil.createItem(Material.COMMAND_BLOCK, prefix + "§fCommand:", getString("Command" +"."+t)));
		
		IntStream.range(0,8).forEach((int q) -> {
			inv.setItem(45 + q, InvUtil.createItem(Material.LIGHT_BLUE_STAINED_GLASS_PANE, "§f", null));
		});
