...
public class Vars {
	...
	public boolean compare(String s) {
		...
		case "more": {return (val < comp) ? t : !t;}
		case "less": {return (val > comp) ? t : !t;}
		case "moreorequals": {return (val <= comp) ? t : !t;}
		case "lessorequals": {return (val >= comp) ? t : !t;}
		case "equals": {return (val == comp) ? t : !t;}
